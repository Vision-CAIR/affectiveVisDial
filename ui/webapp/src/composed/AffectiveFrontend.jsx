...
import { AppContext, INPUT_MODE } from "./AffectiveChatApp.jsx";
import EmojiFormResponse from "./EmojiFormResponse.jsx";

function AffectiveFrontend({
  messages,
  onMessageSend,
  inputMode,
  renderSidePane,
...
export default AffectiveFrontend;
...
def load_image_data():
    import pickle
    with open('/home/haydark/dev/artemis/artemis_for_dialog_66k.pickle', 'rb') as handle:
...
def main(operator: "Operator", cfg: DictConfig) -> None:
    ...
    world_opt = {"num_turns": cfg.num_turns, "turn_timeout": cfg.turn_timeout, "image_data": image_data}
